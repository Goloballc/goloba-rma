...
<x-shop::layouts.account>
    ...
    @pushOnce('scripts')
            ...
            <div class="w-full overflow-auto">
                ...
                >
                    <form
                        ...
                        ref="rmaSubmit"
                    >
                        <v-rma-modal ref="rmaModel">
                            <!-- Modal Header -->
                            <template v-slot:header="{ toggle }">
                                <div class="flex items-center justify-between gap-5 border-b border-zinc-200 bg-white p-6 max-sm:px-4 max-sm:py-3">
                                    <h2 class="text-base font-medium max-md:text-base">
                                        @lang('rma::app.shop.customer.create.heading')
                                    </h2>
                                    <span class="icon-cancel cursor-pointer text-3xl max-sm:text-2xl" @click="toggle"></span>
                                </div>
                            </template>

                            <!-- Modal Content -->
                            <template v-slot:content>
                                <div class="bg-white p-4 max-sm:p-3">
                ...
                <form ref="rmaRetractoSubmit">
                    <v-rma-modal ref="rmaModelRetracto">
                        <template v-slot:header="{ toggle }">
                            <div class="flex items-center justify-between gap-5 border-b border-zinc-200 bg-white p-6 max-sm:px-4 max-sm:py-3">
                                <h2 class="text-base font-medium max-md:text-base">
        ...
        {{-- Componente modal propio del RMA — independiente del v-modal del vendor.
             Usa flex-col + overflow-y-auto en el content para que header y footer
             queden fijos y solo el contenido scrollee, sin importar cuánto haya. --}}
        <script type="text/x-template" id="v-rma-modal-template">
            <div>
                ...
                <transition name="modal-content">
                    ...
                    >
                        <div
                            class="relative w-full max-w-[595px] max-md:w-[90%] rounded-lg bg-zinc-100 flex flex-col"
        ...
        <script type="module">
            app.component('v-rma-modal', {
                template: '#v-rma-modal-template',
