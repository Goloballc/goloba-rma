@component('shop::emails.layout')
    <div style="margin-bottom:34px;">
        ...
        <span style="font-size:22px;font-weight:600;color:#121A26;">
            @lang('goloba-rma::app.mail.new-request.title-customer')
        </span>

        <p style="font-size:16px;color:#5E5E5E;line-height:24px;margin-top:16px;">
            @lang('goloba-rma::app.mail.new-request.greeting', ['name' => $data['name']]) 👋
        </p>

        <p style="font-size:16px;color:#5E5E5E;line-height:24px;">
            @lang('goloba-rma::app.mail.new-request.body-customer')
        </p>
        ...
        <p style="font-weight:600;color:#374151;margin-bottom:4px;">
            @lang('goloba-rma::app.mail.new-request.products-label')
        </p>
        @include('goloba-rma::emails.partials.product-table', ['items' => $data['order_items'], 'rmaData' => $data])

        {{-- CTA --}}
        <div style="text-align:center;margin-top:32px;">
            <a href="{{ route('rma.customer.view', $data['rma_id']) }}"
        ...
        <p style="font-size:13px;color:#9ca3af;margin-top:24px;text-align:center;">
            @lang('goloba-rma::app.mail.new-request.footer')
        </p>
